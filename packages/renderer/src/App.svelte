...
import FutureScopePlaceholder from './lib/layout/FutureScopePlaceholder.svelte';
...
import { currentScreen, registerPrototype } from './stores/prototype';
...
registerPrototype<{ showTabsChrome: boolean }>({
  name: 'Tabs & Flexible Layout',
  screens: [
    { value: 'tabs-layout', label: 'Tabs & Flexible Layout' },
    { value: 'future', label: 'Future idea (later)' },
  ],
  overrides: {
    'tabs-layout': { showTabsChrome: true },
    future: { showTabsChrome: false },
  },
});
  ...
  <main class="flex flex-col w-screen h-screen overflow-hidden">
    ...
    <div class="flex flex-row w-full h-full overflow-hidden">
      ...
      <div
        ...
        {#if $currentScreen === 'future'}
          <FutureScopePlaceholder />
        {:else}
